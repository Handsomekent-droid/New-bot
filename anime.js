  ...
  if (m.isGroup) {
    ...
    if (body && body.includes(`@${mentionNumber}`)) {
      ...
      if (typeof reaction === 'function') {
        ...
        try { await james.sendMessage(m.chat, { text: "❓my owner james tech was tagged and i dislike it , please behave" }, { quoted: m }); } catch (e) {}
      }
    }
  }
} catch (ePresence) {
...
newsletterName: `⿻l ꙰l𝗔𝗡𝗜𝗠𝗘⿻☙𝗖𝗟𝗜𝗘𝗡𝗧 ꙰⿻`,
jpegThumbnail: "https://i.ibb.co/nNjMJy3T/x.jpg",
caption: 'fuck you',
...
externalAdReply: {
title: "l ꙰l𝗔𝗡𝗜𝗠𝗘⿻☙𝗖𝗟𝗜𝗘𝗡𝗧 ꙰⿻", 
body: "",
thumbnailUrl: "https://i.ibb.co/nNjMJy3T/x.jpg", 
sourceUrl: null,
mediaType: 1
}}}, { quoted : loli })
}
...
_Type any command above to view specific menu_
`
    ...
    await james.sendMessage(m.chat, {
        ...
        contextInfo: {
            ...
            externalAdReply: {
                title: "𝗔𝗡𝗜𝗠𝗘 𝗠𝗗",
                body: "by James Tech Incorporative",
                mediaType: 1,
                thumbnailUrl: face,
                sourceUrl: "https://t.me/jamespydev",
...
> ┃༆ sc
> ┗━━━━━━━━━━━━━━━─`,
        button: { text: "𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url: "https://whatsapp.com/channel/0029VaogSY74IBhJWe8b472H" },
...
> ┃༆ autoread
> ┗━━━━━━━━━━━━━━━─`,
        button: { text: "𝗚𝗥𝗢𝗨𝗣", url: "https://chat.whatsapp.com/KkZLAXdytZV8OVYvGwYePY?mode=ems_copy_t" },
        image: "https://i.ibb.co/nNjMJy3T/x.jpg"
      },
      {
        title: "DEVELOPER",
...
> ┃༆ encrypt
> ┗━━━━━━━━━━━━━━━─`,
        button: { text: "𝗢𝗪𝗡𝗘𝗥", url: "https://wa.me/message/NNEIFUPODJTKN1" },
        image: "https://i.ibb.co/nNjMJy3T/x.jpg"
      },
      {
        title: "UTILITY",
...
> ┃༆ sc
> ┗━━━━━━━━━━━━━━━─`,
        button: { text: "𝗗𝗘𝗩 𝗚𝗖", url: "https://chat.whatsapp.com/GJbpJkQRt3Z8v8MctRj7qM?mode=ems_copy_t" },
        image: "https://i.ibb.co/nNjMJy3T/x.jpg"
      },
      {
        title: "DOWNLOAD &FUN",
...
> ┗━━━━━━━━━━━━━━━─`,
  ...
  try {
    ...
    const target = m.chat;
    const thumbPath = path.join(__dirname, 'media', 'love.jpeg');

    if (!fs.existsSync(thumbPath)) return reply('❌ Missing ./media/love.jpeg');
            ...
            nativeFlowMessage: {
                    ...
                    sections: [
                      {
                        ...
                        rows: [
                          ...
                          { title: "PING", description: "check anime speed", id: ".ping" },
              ...
              messageParamsJson: JSON.stringify({
                bottom_sheet: {
                  ...
                  list_title: "james tech Incorporative devs",
                  button_title: "\0"
                },
                limited_time_offer: {
                  text: "⃪𝗔𝗡𝗜𝗠𝗘 𝗠𝗗",
...
case 'dark-ai': {
  try {
    ...
    if (ownerDevRegex.test(prompt)) {
      const ownerAnswer = "This AI was created by James Tech Incorporative developers for doing what weak AIs cant do.";
...
case "repo": {
  try {
    ...
    await james.sendMessage(m.chat, {
      productMessage: {
        title: "𝗔𝗡𝗜𝗠𝗘 𝗠𝗗 𝗧𝗛𝗘 𝗥𝗘𝗔𝗟 𝗩𝗢𝗜𝗗",
        description: "This is the official script release.",
        thumbnail: { url: "https://i.ibb.co/nNjMJy3T/x.jpg" },
        productId: "PROD001",
        retailerId: "RETAIL001",
        url: "https://github.com/james",
        body: "𝗮𝗻𝗶𝗺𝗲 𝗺𝗱 𝗶𝘀 𝘁𝗵𝗲 𝗮𝗱𝘃𝗮𝗻𝗰𝗲𝗱 𝗺𝗱 𝗯𝗼𝘁 𝗰𝗿𝗲𝗮𝘁𝗲𝗱 𝗯𝘆 𝗷𝗮𝗺𝗲𝘀 𝘁𝗲𝗰𝗵 𝗶𝗻𝗰𝗼𝗿𝗽𝗼𝗿𝗮𝘁𝗶𝘃𝗲 𝗳𝗼𝗿 𝗮𝘂𝘁𝗼𝗺𝗮𝘁𝗲𝗱",
    ...
    try {
      await james.sendMessage(m.chat, {
        ...
        footer: "Powered by James Tech",
        templateButtons: [
          { index: 1, urlButton: { displayText: "Get Bot", url: "https://whatsapp.com/channel/0029VaogSY74IBhJWe8b472H" } }
        ]
      }, { quoted: m });
    } catch (secondErr) {
      console.error('fallback also failed:', secondErr);
      await james.sendMessage(m.chat, { text: "script : https://whatsapp.com/channel/0029VaogSY74IBhJWe8b472H" }, { quoted: m });
    }
  }
}
break;
      ...
      const template = {
        templateMessage: {
          hydratedTemplate: {
            ...
            hydratedFooterText: 'Powered by James Tech',
            hydratedButtons: [
...
case 'play': {
  try {
    ...
    if (query.length > 200) return reply(`📝 Song name too long! Max 200 chars.`);
    ...
    // Use downloader API (keep an eye on rate limits / reliability)
    const apiUrl = `https://api.privatezia.biz.id/api/downloader/ytmp3?url=${encodeURIComponent(video.url)}`;
    const apiRes = await axios.get(apiUrl, { timeout: 20000 }).catch(e => {
      throw new Error("Failed to contact download API.");
    });
    const apiData = apiRes.data;
    if (!apiData || !apiData.status || !apiData.result || !apiData.result.downloadUrl) {
      throw new Error("API failed to fetch track information.");
    }
    ...
    // Download MP3 as stream to file
    const audioResponse = await axios({
      method: "get",
      url: apiData.result.downloadUrl,
      responseType: "stream",
      timeout: 600000
    }).catch(e => { throw new Error("Failed to download audio stream."); });
    ...
    await new Promise((resolve, reject) => {
      ...
      // also handle early request errors
    ...
    if (!fs.existsSync(filePath) || fs.statSync(filePath).size === 0) {
      ...
      throw new Error("Download failed or produced empty file.");
    }

    // Optionally show nice caption then send audio
    await james.sendMessage(from, {
      text: `🎶 Playing: *${safeTitle}*\n🎥 Source: ${video.url}`
    }, { quoted: m });

    // Send audio as file (buffer) to ensure Baileys reads it
...
case 'stiker': {
  try {
    if (!isMedia && !m.quoted) return reply('Reply to an image/video or send one with the command.');
    const mediaMsg = isMedia ? m : m.quoted;
    const saved = await downloadAndSaveMediaMessage(mediaMsg, `./tmp/stk_${Date.now()}`);
    // send as sticker (Baileys accepts buffer or file path)
    const stickerBuffer = fs.readFileSync(saved);
    await james.sendMessage(m.chat, { sticker: stickerBuffer }, { quoted: m });
    try { fs.unlinkSync(saved) } catch (e) {}
  } catch (e) {
    console.log(e);
    reply('Failed to make sticker: ' + e.message);
  }
}
break
...
• all users
  `.trim();
  let credit = 'https://i.ibb.co/nNjMJy3T/x.jpg'
  await james.sendMessage(m.chat, {
    image: { url: credit },
    caption: creditsText,
